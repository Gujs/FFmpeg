        ...
        if (g_diag) {
            ...
            if (nowd - diag_last >= 1000000) {
                ...
                for (k = 0; k < n && dp < (int)sizeof db - 32; k++)
                    dp += snprintf(db + dp, sizeof db - dp, " in%d:dec=%"PRId64"/skew=%dms/lag=%dms",
