...
void show_help_default(const char *opt, const char *arg)
{
    av_log(NULL, AV_LOG_INFO,
        ...
        "                        subtitle stream in every output — OFF by default, single-input only\n"
        "                        (refused on multiview). -cc_lang <iso639-2> sets the language + G0\n"
        "                        national subset (default: the first non-und audio language);\n"
        "                        -cc_magazine 1-8 / -cc_page 0x00-0xFF place the page (default\n"
        "                        8 / 0x88 = page 888); PTV_NO_CC=1 kills the whole path\n"
